    ...
    <div className="bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 text-white">
      <div className="container mx-auto py-4">
        <div className="flex justify-between items-center">
          ...
          <Link className="text-xl font-semibold" href="#featured-cat">
            Build By Category
          </Link>
        </div>
        <p className="text-sm mt-1">Discover the best of functionality and versatility</p>
        <Link className="bg-yellow-800 text-white py-2 px-4 rounded-md mt-4 font-semibold inline-block"  href="#featured-cat">
          Explore Now
        </Link>
      </div>
    </div>
